...
climindvis_hc_NCEP2 <- process_nc_file_precip_CDS(
  nc_file_path = "data/hindcasts/NCEP2.nc",
  data_info = list(type="grid_hc", date_format="t2d", data_name="NCEP2 hindcast", fmon="01"),
  factor = 1000, 
  diff = TRUE
)

climindvis_hc_BOM2 <- process_nc_file_precip_CDS(
  nc_file_path = "data/hindcasts/BOM2.nc",
  data_info = list(type="grid_hc", date_format="t2d", data_name="BOM2 hindcast", fmon="02"),
  factor = 1000, 
  diff = TRUE
)

climindvis_hc_ECCC5 <- process_nc_file_precip_CDS(
  nc_file_path = "data/hindcasts/ECCC5.nc",
  data_info = list(type="grid_hc", date_format="t2d", data_name="ECCC5 hindcast", fmon="01"),
  factor = 1000, 
  diff = TRUE
)

climindvis_hc_ECMWF51 <- process_nc_file_precip_CDS(
  nc_file_path = "data/hindcasts/ECMWF51.nc",
  data_info = list(type="grid_hc", date_format="t2d", data_name="ECMWF51 hindcast", fmon="01"),
  factor = 1000, 
  diff = TRUE
)

climindvis_hc_JMA3 <- process_nc_file_precip_CDS(
  nc_file_path = "data/hindcasts/JMA3.nc",
  data_info = list(type="grid_hc", date_format="t2d", data_name="JMA3 hindcast", fmon="01"),
  factor = 1000, 
  diff = TRUE
)

climindvis_hc_MF5 <- process_nc_file_precip_CDS(
  nc_file_path = "data/hindcasts/MF5.nc",
  data_info = list(type="grid_hc", date_format="t2d", data_name="MF5 hindcast", fmon="01"),
  factor = 1000, 
  diff = TRUE
)
